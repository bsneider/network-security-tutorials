...
Also, note that the services provided by this sample project do not necessarily satisfy the
...
parser.add_argument(
    "-s", "--server", default="localhost", help="Server IP address or name"
)
...
parser.add_argument("-u", "--user", default="Alice", help="name of user")
...
# Create the google protobuf message -- format is defined in messaging-app.proto
# This is in some sense for illustration what you can do with protobuf
